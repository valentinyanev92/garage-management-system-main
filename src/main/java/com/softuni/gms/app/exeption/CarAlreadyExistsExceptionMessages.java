...
public class CarAlreadyExistsExceptionMessages {
    ...
    public static final String CAR_PLATE_EXIST = "Plate number already exists";
    public static final String CAR_PLATE_EXIST_CAR_PREVIOUSLY_DELETED = "Plate number already exists (car previously deleted) - contact Administrator!";
}
